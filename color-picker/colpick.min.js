...
$(document).ready(function(){
	...
	setTimeout(function(){
		$("#color-picker").addClass("animated fadeInDown");
	},600);

	$('#color-picker').colpick({
		layout: 'rgbhex',
		submit: 1,
		color:{r:110,g:204,b:68},
		onSubmit: function(hsb,hex,rgb,el,bySetColor){
			$("head").append(
				'<style>a,.portrait__social-media a:hover,.portfolio__grid__item__desc__link:hover span[class^="icon-"],.portfolio__detail__desc__more-link:hover span[class*="icon"],.blog__frontpage__more-link:hover span[class*="icon"] {color: rgb('+rgb.r+","+rgb.g+","+rgb.b+')}'+
				'.page-heading,.skill-list-1__bar,.skill-list-2__bar,.portfolio__grid__item__mask:before,.form__submit,.emedu-list-1 li:before,.emedu-list-2__station:before {background: rgb('+rgb.r+","+rgb.g+","+rgb.b+');}'+
				'.navigation li:hover {box-shadow: inset 0.25em 0 0 rgb('+rgb.r+","+rgb.g+","+rgb.b+');}'+
				'.testimonial:before {background: rgba('+rgb.r+","+rgb.g+","+rgb.b+',0.75);}'+
				'.quote {border-right: 0.25em solid rgb('+rgb.r+","+rgb.g+","+rgb.b+');}'+
				'.emedu-list-1__date {background: rgba('+rgb.r+","+rgb.g+","+rgb.b+',0.9);}'+
				'.contact__address,.contact__web {box-shadow: inset 0.25em 0 0 rgba('+rgb.r+","+rgb.g+","+rgb.b+',0.75);}'+
				'</style>');
		}
	});
